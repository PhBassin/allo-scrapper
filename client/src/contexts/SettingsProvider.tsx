    ...
    const refreshAdminSettings = useCallback(async () => {
        ...
        try {
            ...
            setPublicSettings({
                ...
                color_text_secondary_dark: settings.color_text_primary_secondary_dark,
    ...
    const updateSettings = useCallback(async (updates: AppSettingsUpdate): Promise<AppSettings> => {
        ...
        try {
            ...
            setPublicSettings({
                ...
                color_text_secondary: updatedSettings.color_text_primary_secondary,
                ...
                color_text_secondary_dark: updatedSettings.color_text_primary_secondary_dark,
