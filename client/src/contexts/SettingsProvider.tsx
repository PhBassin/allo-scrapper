    ...
    const refreshAdminSettings = useCallback(async () => {
        ...
        try {
            ...
            setPublicSettings({
                ...
                color_text_primary_dark: settings.color_text_primary_dark,
    ...
    const updateSettings = useCallback(async (updates: AppSettingsUpdate): Promise<AppSettings> => {
        ...
        try {
            ...
            setPublicSettings({
                ...
                color_text_primary: updatedSettings.color_text_primary,
                ...
                color_text_primary_dark: updatedSettings.color_text_primary_dark,
