...
const tabs: Tab[] = [
  ...
  },
  {
    id: 'users',
    label: 'Users',
    anyPermissions: ['users:list', 'users:read', 'users:create', 'users:update', 'users:delete'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'roles',
    label: 'Roles',
    anyPermissions: ['roles:list', 'roles:read', 'roles:create', 'roles:update', 'roles:delete'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'settings',
    label: 'Settings',
    anyPermissions: ['settings:read', 'settings:update', 'settings:reset', 'settings:export', 'settings:import'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'ratelimits',
    label: 'Rate Limits',
    anyPermissions: ['ratelimits:read', 'ratelimits:update', 'ratelimits:reset', 'ratelimits:audit'],
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div role="tabpanel">
        ...
        {activeTab === 'ratelimits' && <RateLimitsPage />}
