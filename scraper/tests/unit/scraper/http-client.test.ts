...
describe('http-client', () => {
  ...
  describe('validateMovieId (via fetchMoviePage)', () => {
    it('should accept positive integer movie IDs', async () => {
