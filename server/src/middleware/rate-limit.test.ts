process.env.JWT_SECRET = 'this-is-a-super-strong-jwt-key-for-testing-purposes-1234567890';
...
// Helper: sign a minimal JWT for rate-limit key tests (we use jwt.verify)
