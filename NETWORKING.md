...
**Recommended:** Use a reverse proxy (nginx) with HTTPS and authentication for production internet access. See [DEPLOYMENT.md](./DEPLOYMENT.md) for details.
...
See [DEPLOYMENT.md](./DEPLOYMENT.md) for complete custom domain setup.
...
- [Setup Guide](./SETUP.md) - Environment variables (ALLOWED_ORIGINS)
- [Docker Deployment](./DOCKER.md) - Production setup
- [Troubleshooting](./TROUBLESHOOTING.md) - Network and CORS issues
- [DEPLOYMENT.md](./DEPLOYMENT.md) - Custom domain and HTTPS
